...
bool foundWallCloseOnSide(Side side) {
    ...
    volatile bool found = Vision.found(TALL, side, 300 /* TODO: Tune wall max distance */);
    return found;
}
...
bool foundWeightFarOnSide(Side side) {
    volatile bool found = closeDistance /* TODO: Tune weight close distance */ < weightDistanceOnSide(side);
    return found;
}

bool foundWeightCloseOnSide(Side side) {
    int weightDistance = weightDistanceOnSide(side);
    volatile bool found = 0 < weightDistance && weightDistance <= closeDistance; /* TODO: Tune weight close distance */
    return found;
}
...
void routineCloseOnSide(Side side) {
...
void actionCloseOnLeft() {
    routineCloseOnSide(LEFT);
}

void actionCloseOnRight() {
