// ****************************************************************
// Name: Orbit ADC_with_UART.c
// Original author: Texas Instruments
// Date: unknown
// Modifications: Dr Steve Weddell
// Purpose: An aid to teach analog-to-digital conversion on the TIVA
// Requirement(s): i) Potentiometer in Orbit Boosterpack ii) UART
//   ii) circular buffer to store values.
// Use: Modified for ENCE361 laboratory in Week-3
// Last modified: 2 March 2017 by Steve Weddell
// Additional circular buffer files courtesy of Phil Bones
// *****************************************************************
//
#include <stdbool.h>
#include <stdint.h>
...
//#define SAMPLE_RATE_HZ 10 // Not used in this program instance
...
main(void)
{
    ...
    UARTprintf("  Analog source: Orbit potentiometer\n\n");
    ...
    while(1)
    {
			...
			g_inBuffer.data[g_inBuffer.windex] = (int) pui32ADC0Value;
			g_inBuffer.windex++;
