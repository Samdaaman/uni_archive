...
function func_plot_results(A, B_1, C_1, K)
    ...
    yline(10, "r:")
    legend(["y\_x", "y\_theta", strcat("rise\_time\_x: ", string(rise_time_x)), strcat("settling\_time\_x: ", string(settling_time_x)), strcat("settling\_time\_theta: ", string(settling_time_theta)), "10 degrees overshoot limit"])
    hold off
end