...
% the three carts with Schurs Complement. Solving to score gains of K.
...
lmiterm([1 1 1 P],.5*(A'-K'*B1'),1,'s');        % LMI #1: (A'-K'*B1')*P (NON SYMMETRIC?)
lmiterm([1 1 1 P],.5*1,(A-B1'*K'),'s');         % LMI #1: P*(A-B1'*K') (NON SYMMETRIC?)
...
[tmin,xfeas] = feasp(hinfinity,options,-1); % '-1' asks tmin to be less than or equal to –1.
